...
/**
 * AccountService Web服务的功能测试  
 * 
 * <p>该类测试需要项目运行mvn tomcat7:run 
 * 
 * @author chenlg
 */
...
public class AccountSoapClientFT {
    ...
    public void deleteUser() {
        WSResult response = accountSoapClientFacade.deleteUser(new Integer(16));
